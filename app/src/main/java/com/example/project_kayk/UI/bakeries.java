...
public class bakeries extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void Retrieve_Mini_Treats() {
        ...
        my_adapter = new GridproductAdapter(lastmodels, favourites,bakeries.this);
        ...
        GridLayoutViewBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(bakeries.this,CategoryActivity.class);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.Profile) {
            startActivity(new Intent(bakeries.this, UserProfileActivity.class));
        }
        else if(id == R.id.favourites){
            startActivity(new Intent(bakeries.this, favourites_activity.class));
        }
        else if(id == R.id.feedback){
            startActivity(new Intent(bakeries.this, feedback.class));
        }

        else if(id == R.id.Cart){
            startActivity(new Intent(bakeries.this, CartActivity.class));
        }
        else if(id == R.id.MyOrders){
            startActivity(new Intent(bakeries.this, OrderActivity.class));
        }

        else if(id == R.id.help){
            startActivity(new Intent(bakeries.this, help.class));
        }
        else if(id == R.id.about){
            startActivity(new Intent(bakeries.this, aboutus.class));
        }
    ...
    private void CheckLogout(){
        AlertDialog.Builder checkAlert = new AlertDialog.Builder(bakeries.this);
        checkAlert.setMessage("Do you want to Logout?")
                .setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                FirebaseAuth.getInstance().signOut();
                Intent intent=new Intent(bakeries.this,loginActivity.class);
                startActivity(intent);
                finish();
            }
