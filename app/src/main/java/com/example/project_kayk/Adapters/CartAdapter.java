...
import com.example.project_kayk.Model.CartItemModel;
...
public class CartAdapter extends RecyclerView.Adapter  {
    ...
    class cartItemViewHolder extends RecyclerView.ViewHolder  {
        ...
        void setItemDetails(String resource, final String title, int freeCouponsNo, final int productPriceText, int quantity, String cutprice, int offerAppliedNo){
            ...
            productprice.setText("Price: "+String.valueOf(productPriceText * quantity )+" Rs");
            ...
            PlusIcon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    productprice.setText("Price: "+String.valueOf(productPriceText *Integer.parseInt( productQuantity.getText().toString()) )+" Rs")  ;
        ...
        ValueEventListener valueEventListener =new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    mListener.UpdateTotalPrice(String.valueOf(totalpriceVal)+" Rs");
                }
            }
